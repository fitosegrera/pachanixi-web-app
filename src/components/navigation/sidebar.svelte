...
<div class="sidebar bg-primary-dark" transition:fly={{ y: -1080, opacity: 1 }}>
	...
	{/each}
	<div class="flex items-center justify-center h-full w-auto sm:space-x-24 md:space-x-48">
		{#each social as item}
			<div class="sm:text-h7 md:text-h5 mt-16 hover:text-primary-light cursor-pointer">
