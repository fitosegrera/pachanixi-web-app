...
<div
	class="h-auto max-w-fit cursor-pointer rounded-md border-4 border-primary-main text-p3 font-bold text-primary-main hover:bg-primary-main hover:text-primary-dark">
	<a
		id="login"
